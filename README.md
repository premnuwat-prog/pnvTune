...
5. ปุ่ม **−** เอาแถวสุดท้ายออกและปิดคอร์ดนั้น จำนวนแถวถูกบันทึกไว้กับโปรเจกต์ แต่ละแถวมีสวิตช์เลข 1–5 ที่ทำ automation แยกกันได้
...
เวอร์ชัน 0.3 ใช้ YIN ที่เพิ่ม median smoothing, การยืนยันโน้ตใหม่สองเฟรม และ hold สั้น ๆ เมื่อตัวตรวจขาดช่วง เพื่อลดอาการเป้าหมายสะบัด
